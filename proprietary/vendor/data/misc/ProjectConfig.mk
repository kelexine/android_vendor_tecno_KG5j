...
AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE = MTK_FUSED_LOCATION_SUPPORT MTK_CAM_ZSDHDR_SUPPORT MTK_CAM_ZSDMFB_SUPPORT SIM_ME_LOCK_MODE CUSTOM_CONFIG_MAX_DRAM_SIZE MTK_MD_SBP_CUSTOM_VALUE MTK_CAM_MFB_SUPPORT MTK_NFC_SE_NUM MTK_LCM_PHYSICAL_ROTATION LCM_WIDTH MTK_EXTERNAL_MODEM_SLOT LCM_HEIGHT
...
#BSP: modify for kg5j XLWQHBLSLL-1680 by long.chen 20210909 start
BOOT_LOGO = hdplus1612
#BSP: modify for kg5j XLWQHBLSLL-1680 by long.chen 20210909 end
BUILD_AGO_GMS = yes
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-KG5J-H6126-A
#BSP: add project macro by wanghanfeng 20201102 start
#BSP: add for KFLHLEYJ-18 by muduo.qin 20201114 start
CUSTOM_CONFIG_MAX_DRAM_SIZE = 0x80000000
#BSP: add for KFLHLEYJ-18 by muduo.qin 20201114 end
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc08a3_mipi_raw s5k4h7sub_mipi_raw gc6153_serial_yuv gc6133_serial_yuv pblcs5k3l6_mipi_raw pblcs5k3l6ext2_mipi_raw pblcgc08a3_mipi_raw pblcs5k4h7sub_mipi_raw pblcgc6153_serial_yuv pblcgc6133_serial_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw
CUSTOM_TRAN_HAL_MAIN2_IMGSENSOR = gc6153_serial_yuv gc6133_serial_yuv
CUSTOM_HAL_SUB_IMGSENSOR = gc08a3_mipi_raw s5k4h7sub_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA = 3
#ITD:modify by camera driver team end
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 start
CUSTOM_HAL_MSENSORLIB =
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 end
#BSP add KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 start
TRAN_SINGLE_ALS_CALI = yes
#BSP add KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201109 end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3l6ext2_mipi_raw gc08a3_mipi_raw s5k4h7sub_mipi_raw gc6153_serial_yuv gc6133_serial_yuv
#ITD:modify by camera driver team end
...
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201127 start
...
#BSP modify KFLJHLEYB-1 [P1 debug] by yilong.luo for 20201127 end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc08a3_mipi_raw s5k4h7sub_mipi_raw
#ITD:modify by camera driver team end
...
#TDD: modify KGWHLYEW-4 by jiahu.zhong 20210722 start
CUSTOM_MODEM=kg5_h6125_a1_go
#TDD: modify KGWHLYEW-4 by jiahu.zhong 20210722 end
...
#SPD:modify aal KFLHLEYJ-30 by shuaishuai.ren 20201225 start
MTK_AAL_SUPPORT = yes
#SPD:modify aal KFLHLEYJ-30 by shuaishuai.ren 20201225 end
...
#BSP:modify audio bring up KGWHLYEW-2 xinyu.zhao 20210813 start
MTK_AUDIO_HD_REC_SUPPORT = yes
#BSP:modify audio bring up KGWHLYEW-2 xinyu.zhao 20210813 start
MTK_AUDIO_HYBRID_NLE_SUPPORT = no
MTK_AUDIO_MIC_INVERSE = no
#BSP:modify audio bring up KFLHLEYJ-5 xinyu.zhao 20201112 start
MTK_AUDIO_NUMBER_OF_MIC = 1
MTK_AUDIO_NUMBER_OF_SPEAKER = 1
MTK_AUDIO_SPEAKER_PATH = int_hp_buf
#BSP:modify audio bring up KFLHLEYJ-5 xinyu.zhao 20201112 end
...
#BSP:modify audio bring up KGWHLYEW-2 xinyu.zhao 20210830 start
MTK_BESLOUDNESS_SUPPORT = yes
#BSP:modify audio bring up KGWHLYEW-2 xinyu.zhao 20210830 end
...
#TSD:add FM support TSTD-151 by yunfei.wu 20201119 start
MTK_FMRADIO_APP = yes
...
#TSD:add FM support TSTD-151 by yunfei.wu 20201119 end
...
#TSD: modify modem KFLHLEYJ-109 by ang.gu 20201128 start
MTK_MULTIPLE_IMS_SUPPORT = 2
#TSD: modify modem KFLHLEYJ-109 by ang.gu 20201128 end
...
#TSD: modify VSIM TSDT-76 ang.gu 20201021 start
MTK_NUM_MODEM_PROTOCOL = 3
#TSD: modify VSIM TSDT-76 ang.gu 20201021 end
...
#TSD:modify KFLHLEYJ-13 by ang.gu 20201115 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
#TSD:modify KFLHLEYJ-13 by ang.gu 20201115 end
...
#TSD:modify WFD KFLHLEYJ-123 by yunfei.wu 20201210 start
MTK_WFD_SUPPORT = yes
#TSD:modify WFD KFLHLEYJ-123 by yunfei.wu 20201210 end
...
#TSD:modify KFLHLEYJ-83 for change sim onoff mode by qingming.song 2020.11.27 start
MTK_SIM_CARD_ONOFF = 1
#TSD:modify KFLHLEYJ-83 for change sim onoff mode by qingming.song 2020.11.27 end
#ITD: modify for KFLHLEYJ-15 to improve camera Performance by xuelong.chen 20201119 start
MTK_CAM_BGSERVICE_SUPPORT = yes
#ITD: modify for KFLHLEYJ-15 to improve camera Performance by xuelong.chen 20201119 end
...
MTK_CAM_LAZY_HAL = no
#ITD: modify for KFLHLEYJ-15 to improve camera Performance by xuelong.chen 20201119 end
#SPD: modify for KFLHLEYJ-566 to improve app clod start performance by fan.feng1 20210106 start
MTK_PERF_PLUS = no
#SPD: modify for KFLHLEYJ-566 to improve app clod start performance by fan.feng1 20210106 end
#SPD: add KFLHLEYJ-31 open GIFT by bin.song 2020108 start
MTK_ARC_GIFT_SUPPORT = yes
#SPD: add KFLHLEYJ-31 open GIFT by bin.song 2020108 end
...
#TSD: modify modem KFLHLEYJ-138 by ang.gu 20201128 start
MTK_DYNAMIC_CCB_BUFFER_GEAR_ID = 2
#TSD: modify modem KFLHLEYJ-138 by ang.gu 20201128 end
...
#SPD:modify aal KFLHLEYJ-1054 by shuaishuai.ren 20201210 start
MTK_ESS_SUPPORT = yes
#SPD:modify aal KFLHLEYJ-1054 by shuaishuai.ren 20201210 end
...
MTK_TOUCHPANEL_KO =
#BSP: add project clone format by wanghanfeng 20201102 start
...
#BSP: add project macro by wanghanfeng 20201102 start
CUSTOM_TRAN_PROJECT=tran_kg5j
CUSTOM_TRAN_BOM=tran_kg5j_a1
#BSP: add project macro by wanghanfeng 20201102 end
